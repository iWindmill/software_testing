...
Первая запись представляет название; ее содержание используется как заголовок каждого выходного ответа.
